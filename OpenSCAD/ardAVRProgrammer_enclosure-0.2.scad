...
module lid() {
  ...
  difference() {
	...
	translate([casWallThick + 0.2, casWallThick + 0.2, -lidInset])
	  color("green")
	  cube([ardWidth + extraWidthL + extraWidthR + casWallThick * 2 -(casWallThick + 0.2) * 2, ardDepth + extraDepthD + extraDepthU + casWallThick * 2 -(casWallThick + 0.2) * 2, lidInset]);
	
	translate([casWallThick + 0.2 + 2, casWallThick + 0.2 + 2, -lidInset])
	  color("red")
	  cube([ardWidth + extraWidthL + extraWidthR + casWallThick * 2 -(casWallThick + 0.2) * 2 - 2 * 2, ardDepth + extraDepthD + extraDepthU + casWallThick * 2 -(casWallThick + 0.2) * 2 - 2 * 2, lidInset]);
      }
     lidOpenings(); 
    }
